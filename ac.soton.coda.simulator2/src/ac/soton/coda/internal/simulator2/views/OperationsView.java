...
/**
 * <p>
 * An implementation for a view for monitoring the operations status during CODA
 * simulations. The content of the view is populated by an
 * {@link OperationsStatusTableViewer}.
 * </p>
 * 
 * @author htson
 * @version 0.1
 * @see OperationsStatusTableViewer
 * @since 0.1
 */
public class OperationsView extends ViewPart {

	// The View ID.
	public static final String VIEW_ID = "ac.soton.coda.simulation2.operationsView"; //$NON-NLS-1$
	 ...
	 * to create a table viewer for operations' status.
	 */
	@Override
	public void createPartControl(Composite parent) {
		viewer = new OperationsStatusTableViewer(parent);
	}
